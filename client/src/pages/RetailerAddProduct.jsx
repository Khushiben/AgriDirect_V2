    ...
    <div className="retailer-add-container">
      <form onSubmit={handleSubmit} className="retailer-add-form">
        ...
        <div className="product-info-card">
          ...
          <img
            src={product.image || `https://images.unsplash.com/photo-1511735643442-503bb3bd348a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Y3JvcHxlbnwwfHwwfHx8MA%3D%3D/327x154/?${product.variety || "farm,crop"}`}
